<footer class="main-footer">
	<div class="cat-footer-wrapper relative">
		<div class="top-left-shap bouncing">
			<img src="{{asset('assets/images/main/shap/02.png')}}" alt="">
		</div>
		<div class="top-right-shap bouncing">
			<img src="{{asset('assets/images/main/shap/04.png')}}" alt="">
		</div>
		<div class="container">
			<div class="row">
					...
					<div class="footer-menu contact-menu">
						<ul>
							...
							<a href="javascript:void(0);">
								...
								<p>Northern Territory 0862 North Australia sovereign country</p>
							</a>
							</li>
					...
					<div class="insta-picture">
						<div class="row">
							...
							<div class="footer-img">
								<a href="javascript:void(0);">
									<img src="{{asset('assets/images/main/event/01.jpg')}}" alt="">
								</a>
							</div>
							</div>
							<div class="col-md-4 col-sm-4 col-4">
							<div class="footer-img">
								<a href="javascript:void(0);">
									<img src="{{asset('assets/images/main/event/02.jpg')}}" alt="">
								</a>
							</div>
							</div>
							<div class="col-md-4 col-sm-4 col-4">
							<div class="footer-img">
								<a href="javascript:void(0);">
									<img src="{{asset('assets/images/main/event/03.jpg')}}" alt="">
								</a>
							</div>
							</div>
							<div class="col-md-4 col-sm-4 col-4">
							<div class="footer-img">
								<a href="javascript:void(0);">
									<img src="{{asset('assets/images/main/event/04.jpg')}}" alt="">
								</a>
							</div>
							</div>
							<div class="col-md-4 col-sm-4 col-4">
							<div class="footer-img">
								<a href="javascript:void(0);">
									<img src="{{asset('assets/images/main/event/05.jpg')}}" alt="">
								</a>
							</div>
							</div>
							<div class="col-md-4 col-sm-4 col-4">
							<div class="footer-img">
								<a href="javascript:void(0);">
									<img src="{{ asset('assets/images/main/event/06.jpg')}} " alt="">
								</a>
							</div>
							</div>
						</div>
	...
	<div class="cat-footer-copyright">
		...
		<p>
			Copyright &copy; {{ date('Y') }} Catering by Skimz Solutions. All Rights Reserved.
		</p>
	</div>
</footer>
<!-- GO To Top -->
